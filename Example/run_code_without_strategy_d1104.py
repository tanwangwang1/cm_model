...
python_script = 'code_without_strategy_d1104.py'  # 要执行的 Python 脚本路径
...
alphas = [1.02,1.04,1.06,1.08,1.10,1.12,1.14,1.16,1.18,1.20]
#seeds =  [7,10,20,67,116,119,161,167,170,192]
seeds = [17,51,75,100,101,104,116,161,170,192]
seeds = [116]
for seed in seeds:
    for alpha in alphas:
        output_path = f'/home/matteo/github_2/experiments_d1104/without_strategy/5blobs5centroids/seed_{seed}/'
